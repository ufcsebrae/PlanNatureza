...
import time
import argparse # Importa a biblioteca para argumentos
...
# ... (as funções capturar_screenshot_relatorio, enviar_via_outlook, e preparar_e_enviar_email_por_unidade permanecem as mesmas da versão anterior) ...
...
def enviar_via_outlook(destinatario: str, cc: str, assunto: str, corpo_html: str, anexos: list[Path] | None = None):
    try:
        ...
        mail.Display() # Abre o e-mail para revisão. Para enviar direto, seria mail.Send()
    ...
    <body style="margin: 0; padding: 0; width: 100%; background-color: #f8fafc;">
        <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background-color: #f8fafc;">
            <tr><td align="center" style="padding: 40px 20px;">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="max-width: 680px; background-color: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; font-family: Calibri, 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -2px rgba(0,0,0,0.1);">
                    <tr><td style="padding: 32px;">
                        ...
                        <div style="background-color: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
                            ...
                            <p style="margin: 0; font-size: 15px; color: #475569; line-height: 1.7;">Para uma leitura rápida de tendências e desvios através de indicadores visuais (Heatmaps e Sunburst), acesse o link abaixo:</p>
                        </div>

                        <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                            <tr><td align="center" style="padding: 12px 0;">
                                <a href="{dashboard_url}" target="_blank" style="background-color: #ffffff; border: 1px solid #1e293b; color: #1e293b; padding: 13px 28px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; display: inline-block;">
                        ...
                        <p style="margin: 32px 0 16px 0; font-size: 16px; color: #334155; line-height: 1.75;">Este ecossistema de dados foi desenhado para que a informação não fique retida, mas sim circule, servindo de suporte para o alcance das nossas metas setoriais e territoriais.</p>
...
def main():
    ...
    # Se a flag --enviar-todos for usada, pula a parte interativa
